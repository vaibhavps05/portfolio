...
const content = [
  {
    ...
    link:"https://book-recommendation-system-6a7j.onrender.com/",
      content: (
        <div>
  ...
  },
  {
    ...
    link:"https://olympics-analysis-qfdp.onrender.com/",
      content: (
      <div className="h-full w-full  flex items-center justify-center text-white">
        <Image
          src="/olympic.png"
  ...
  },
  {
    ...
    link:"https://www.youtube.com/watch?v=P_I9Uep7L5M",  
      content: (
      <div className="h-full w-full  flex items-center justify-center text-white">
        <Image
          src="/t20.png"
  ...
  },
  {
    ...
    link:"https://github.com/vaibhavps05/Fake-news-Detection",
      content: (
      <div className="h-full w-full  flex items-center justify-center text-white">
        <Image
          src="/fake.jpg"
